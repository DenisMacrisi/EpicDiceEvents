...
// Copiază rezultatul testului în directorul de Download
Future<void> saveTestResultsToFile(List<Map<String, dynamic>> results) async {
  try {
    final directory = await getExternalStorageDirectory();
    final path = '${directory!.path}/test_results.json';
    final jsonString = jsonEncode(results);
    final file = File(path);
    await file.writeAsString(jsonString);
    print("Rezultatele testelor au fost salvate la: $path");
  } catch (e) {
    print("Eroare la salvarea rezultatelor: $e");
  }
}
